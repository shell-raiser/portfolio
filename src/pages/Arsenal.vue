            ...
            <v-col>
              ...
              >
                <v-card class="white" rounded flat>
                  <v-card-title
                    class="toolsCardsImageCont deep-purple lighten-4"
                    >Languages
                  </v-card-title>
              ...
              >
                <v-card class="white" rounded flat>
                  <v-card-title class="toolsCardsImageCont red lighten-4"
              ...
              >
                <v-card class="white" rounded flat>
                  <v-card-title class="toolsCardsImageCont teal lighten-4"
                    >Back End Frameworks
                  </v-card-title>
              ...
              >
                <v-card class="white" rounded flat>
                  <v-card-title class="toolsCardsImageCont purple lighten-4"
                    >Design</v-card-title
                  >
              ...
              >
                <v-card class="white" rounded flat>
                  <v-card-title class="toolsCardsImageCont indigo lighten-4"
                    >Audio</v-card-title
                  >
